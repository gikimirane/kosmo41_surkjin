...
%>
	...
	<div>
		...
		<button type="button" onclick="">공개방만들기</button>
		<button type="button" onclick="">비공개방만들기</button>
		<button type="button" onclick="">금칙어 설정</button>
		<button type="button" onclick="">금칙어 해제</button>
		<button type="button" onclick="">숫자야구게임</button>
		<button type="button" onclick="">TicTacToe</button>
	</div>
	<div >
	<hr>
	<div>
	...
	<hr>
	 ...
	 <div>
	<div>
	금착어 : <input id="ban" type="text" name="ban"><br><p>
	...
	<div>
		...
		<button type="button" onclick="">숫자야구게임</button>
		<button type="button" onclick="">TicTacToe</button>
		<button type="button" onclick="exitRoom();">나가기</button>
	</div>
	<div id="messages3">3</div>
	</div>
	</div>
	</div>
	...
	<script type="text/javascript">
		...
		function fclick(bcd, hid){
			...
			if(bcd==1) mbr_id = hid;
			else if(bcd==2) mbr_id = hid;
			else if(bcd==3){
				room_no = hid;
				webSocket.send(id +" 2 " + "/cd " + hid);
				myRoomList();
				roomList();
			}else if(bcd==4) mbr_id = hid;
		}
	</script>
